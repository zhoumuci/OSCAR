          ...
          <table class="cte-table">
            <thead>
              <tr>
                ...
                <th class="gsc-sort-th" @click="togglePairSort('linkScore')"><span class="pgc-th-label"><span>Link score</span><HelpTooltip text="Absolute ArchR peak–gene correlation; larger values indicate a stronger association regardless of direction." label="Link score column help" /><span class="gsc-sort-arrow">{{ pairSortArrow('linkScore') }}</span></span></th>
                <th class="gsc-sort-th" @click="togglePairSort('linkFdr')"><span class="pgc-th-label"><span>Link FDR</span><HelpTooltip text="ArchR false discovery rate for the peak–gene correlation; smaller values indicate stronger statistical evidence." label="Link FDR column help" /><span class="gsc-sort-arrow">{{ pairSortArrow('linkFdr') }}</span></span></th>
              </tr>
            </thead>
            <tbody>
