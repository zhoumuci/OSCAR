...
public class SequencePeak2GeneJobResponse {
    ...
    public SequencePeak2GeneResponse getResult() { return result; }
    public void setResult(SequencePeak2GeneResponse v) { this.result = v; }
}
